...
In dieser Arbeit wird der aktuelle Forschungsstand zur kontextabhängigen Anpassung von Service-Choreographien zusammengefasst. Dazu wird die systematische Literaturrecherche verwendet. Dabei wurde das Vorgehen protokolliert, was die Reproduzierbarkeit dieser Literaturrecherche erhöht. Dabei wurden die dreiteiligen Suchanfragen automatisiert auf den Suchmaschinen Google Scholar, Springer Link und IEEEXplore ausgeführt. Die Ergebnisse wurden manuell nach Ein- und Ausschlusskriterien sortiert wobei insgesamt X %TODO anzahl ergebnisse
themenrelevante Ergebnisse gefunden wurden. Für jedes Ergebnis wurde zusammengefasst, welche Adaptionsstrategie in dem Ansatz verwendet wird. Des Weiteren wurde zusammengefasst, wie die Adaption durchgeführt wird. Dabei wurde aus den Ergebnissen Informationen zum Ziel der Anpassung, der erforderlicher Eingriffsgrad, Aspekte zur Kontextsensitivität, Auswirkungen auf die Skalierbarkeit, bestehende Implementierungen sowie zugrundeliegende Modelle zusammengefasst. Zudem wurden die bestehenden Limitationen zu jedem Ergebnis aufgeführt.
